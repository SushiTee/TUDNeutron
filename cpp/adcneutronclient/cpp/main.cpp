...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterSingletonType<NetworkController>("AdcNeutron.Network", 1, 0, "NetworkController", &NetworkController::instance);
    qmlRegisterSingletonType<Version>("AdcNeutron.Version", 1, 0, "Version", &Version::instance);
