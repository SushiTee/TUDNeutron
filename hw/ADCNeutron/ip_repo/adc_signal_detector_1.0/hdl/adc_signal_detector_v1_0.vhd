...
entity adc_signal_detector_v1_0 is
  generic (
...
end adc_signal_detector_v1_0;

architecture arch_imp of adc_signal_detector_v1_0 is

  -- component declaration
  component adc_signal_detector_v1_0_M00_AXIS is
    generic (
  ...
  end component adc_signal_detector_v1_0_M00_AXIS;

begin

-- Instantiation of Axi Bus Interface M00_AXIS
adc_signal_detector_v1_0_M00_AXIS_inst : adc_signal_detector_v1_0_M00_AXIS
  generic map (
  ...
  port map (
    enabled        => enabled,
    signal_input_a   => signal_input_a,
    signal_input_b   => signal_input_b,
