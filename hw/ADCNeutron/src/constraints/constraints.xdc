...
set_property IOSTANDARD LVCMOS33 [get_ports adc_base_clock2]
...
set_property PACKAGE_PIN V8 [get_ports adc_base_clock]
set_property PACKAGE_PIN V10 [get_ports adc_base_clock2]
