...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set adc_base_clock [ create_bd_port -dir O -type clk adc_base_clock ]
  set adc_base_port2 [ create_bd_port -dir O -type clk adc_base_port2 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {10000000} \
 ] $adc_base_port2
  set csa [ create_bd_port -dir O csa ]
  set csb [ create_bd_port -dir O csb ]
  set leds_8bits1 [ create_bd_port -dir O -from 7 -to 0 leds_8bits1 ]
  set mosi [ create_bd_port -dir O mosi ]
  set normal [ create_bd_port -dir I normal ]
  set pattern [ create_bd_port -dir I pattern ]
  set random [ create_bd_port -dir I random ]
  set sck [ create_bd_port -dir O sck ]
  set sensor_1a_n [ create_bd_port -dir I sensor_1a_n ]
  ...
  # Create instance: adc_signal_detector_0, and set properties
  set adc_signal_detector_0 [ create_bd_cell -type ip -vlnv user.org:user:adc_signal_detector:1.0 adc_signal_detector_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Empty_Threshold_Assert_Value_axis {131070} \
   ...
   CONFIG.Full_Threshold_Assert_Value_axis {131071} \
   ...
   CONFIG.Input_Depth_axis {131072} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports adc_base_clock] [get_bd_ports adc_base_port2] [get_bd_pins processing_system7_0/FCLK_CLK1]
