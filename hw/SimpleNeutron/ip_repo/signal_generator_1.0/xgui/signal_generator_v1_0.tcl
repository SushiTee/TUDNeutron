...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "STOP_DELAY_TICKS"

}

proc update_PARAM_VALUE.STOP_DELAY_TICKS { PARAM_VALUE.STOP_DELAY_TICKS } {
	# Procedure called to update STOP_DELAY_TICKS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.STOP_DELAY_TICKS { PARAM_VALUE.STOP_DELAY_TICKS } {
	# Procedure called to validate STOP_DELAY_TICKS
	return true
}
...
proc update_MODELPARAM_VALUE.STOP_DELAY_TICKS { MODELPARAM_VALUE.STOP_DELAY_TICKS PARAM_VALUE.STOP_DELAY_TICKS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.STOP_DELAY_TICKS}] ${MODELPARAM_VALUE.STOP_DELAY_TICKS}
}
